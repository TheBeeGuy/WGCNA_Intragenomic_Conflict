...
sterileASE <-sterile_brain[active_brain$bias!='No Bias',]
...
overlaps_DEG_background<-intersect(DEG_reproductive,all_mod_genes)
```




```{r define overlap functions}
...
DEG_brain_module_overlap<-sapply(mod_sig_beebase,m_intersect,var2=DEG_brain)
...
moduleDEG_PSGE_genes_results<-left_join(moduleDEG_PSGE_genes_results, brain_pvalues)


write.csv(moduleDEG_PSGE_genes_results,"../output/brain_moduleDEG_PSGE_overlap_results.csv")

...
ovaModules = labels2colors(as.numeric(ovaryMLabels))

consModules =labels2colors(as.numeric(consMLabels))
...
for (omod in 1:nOvaMods)
  for (cmod in 1:nConsMods)
  {
    ...
    CountTbl[omod, cmod] = sum(ovaryMColors == ovaModules[omod] & moduleColors ==consModules[cmod])
  }

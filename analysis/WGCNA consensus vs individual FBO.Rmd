...
consModules =labels2colors(consMLabels)
...
for (omod in 1:nOvaMods)
  ...
  {
    ovaMembers = (ovaModules == ovaryMLabels[omod]);
    consMembers = (consModules == consMLabels[cmod]);
...
labeledHeatmap(Matrix = pTable,
               ...
               ySymbols = paste("Ova ", ovaModuleLabels, ": ", ovaModTotals, sep=""),
               textMatrix = CountTbl,

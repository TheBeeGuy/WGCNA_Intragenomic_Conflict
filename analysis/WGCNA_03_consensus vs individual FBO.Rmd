...
for (omod in 1:nOvaMods)
  for (cmod in 1:nConsMods)
  {
    ...
    ovaMembers = (ovaryMLabels == ovaModuleLabels[omod]);
    consMembers = (consMLabels == consModuleLabels[cmod]);
    pTable[omod, cmod] = -log10(fisher.test(ovaMembers, consMembers, alternative = "greater")$p.value);
    CountTbl[omod, cmod] = sum(ovaryMLabels == ovaModuleLabels[omod] & consMLabels ==

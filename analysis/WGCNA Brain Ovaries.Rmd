...
write.csv(moduleDEGgenes_results,"../output/moduleDEGoverlap_results.csv")
write.csv(module_DEG_DML_results,"../output/module_DEG_DML_overlap_results.csv") 
...
# Select modules
modules =  "3";##select which modules you want to see
